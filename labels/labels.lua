...
export.lang_specific_data_list_module = "labels/data/lang.lua"
...
function export.get_submodules(lang)
	...
	table.insert(submodules, "labels/data.lua")
	table.insert(submodules, "labels/data/qualifiers.lua")
	table.insert(submodules, "labels/data/regional.lua")
	table.insert(submodules, "labels/data/topical.lua")
	return submodules
end
